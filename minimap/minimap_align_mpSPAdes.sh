#!/bin/bash -l
#SBATCH --job-name=minimap_align_CAMI_2_mpSPAdes
...
#SBATCH --array=1-10
#SBATCH --output=slurm_minimapalign_CAMI_2_mpSPAdes_%A_%a.out

# use minimap2 to align CAMI2 contigs to CAMI2 megaplasmidSPAdes minimap2 index
...
INDEX="${WORKDIR}/mpSPAdes_${SAMPLE_ID}_index"
CONTIGS="${CONTIGSDIR}/2018.08.15_09.49.32_sample_${SAMPLE_ID}/contigs/anonymous_gsa.fasta"

# output files 
OUTPUT="${WORKDIR}/CAMI_2_mpSPAdes_alignment_${SAMPLE_ID}"
