...
Making contig size vs. num genes vs. detection for megahit
...
library(vegan)
library(pairwiseAdonis)
# this is for megahit contigs num genes vs. length
# analyze the centroids of scatter plots --> looking at contig_length vs. num gene calls
# create distance matrix and test centroid differences
...
# adonis2(formula = dist_matrix_megahit ~ megahit_detection, data = megahit_query_target)
#            Df   SumOfSqs      R2      F Pr(>F)    
# Model       2 7.8836e+08 0.06313 44.944  0.001 ***
# Residual 1334 1.1700e+10 0.93687                  
# Total    1336 1.2488e+10 1.00000                  
# ---
...
# 1           detected vs undetected_genomad_plasx  1 771143059 75.67490
# 2                 detected vs undetected_genomad  1 156316543 14.10914
# 3 undetected_genomad_plasx vs undetected_genomad  1 131241175 66.16469
#           R2 p.value p.adjusted sig
# 1 0.06686982   0.001      0.003   *
# 2 0.01341034   0.001      0.003   *
# 3 0.10335573   0.001      0.003   *
```
