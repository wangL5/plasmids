...
classifier_plasmids_dir="/work/NRSAAMR/Projects/plasmids/CAMI2_Marine/CAMI2_reads/plasme_run2/plasme_megahit_plasmids"
...
assembly_contigs = read_in_lists(megahit_contigs_dir)
...
output_dir = "/work/NRSAAMR/Projects/plasmids/CAMI2_Marine/CAMI2_reads/plasme_run2/"
os.makedirs(output_dir, exist_ok=True) # does the output dir exist

for n, sublist in enumerate(nonplasmid_list):
    filename = f"plasme_megahit_nonplasmid_{n}.txt"
