...
classifier_plasmids_dir="/work/NRSAAMR/Projects/plasmids/CAMI2_Marine/CAMI2_reads/genomad_run1/mpSPAdes_plasmid_contigs"
...
output_dir = "/work/NRSAAMR/Projects/plasmids/CAMI2_Marine/CAMI2_reads/genomad_run1"
os.makedirs(output_dir, exist_ok=True) # does the output dir exist

for n, sublist in enumerate(nonplasmid_list):
    filename = f"genomad_mpSPAdes_nonplasmid_{n}.txt"
