#!/bin/bash -l
#SBATCH --job-name=PLASMe_CAMI_mpSPAdes
...
#SBATCH --array=1-10
#SBATCH --output=slurm_PLASMe_CAMI_mpSPAdes_%A_%a.out

## use PLASMe to identify plasmid contigs from mpSPAdes assemblies
...
# output files
OUT="${WORKDIR}/plasme_mpSPAdes_${SAMPLE_ID}"
