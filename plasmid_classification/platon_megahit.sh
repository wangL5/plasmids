#!/bin/bash -l
#SBATCH --job-name=platon_CAMI_megahit
...
#SBATCH --array=1-10
#SBATCH --output=slurm_platon_CAMI_megahit_%A_%a.out

## use platon to identify plasmid contigs from megahit assemblies
...
# output files
OUT="${WORKDIR}/platon_megahit_${SAMPLE_ID}/"
