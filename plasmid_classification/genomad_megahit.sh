#!/bin/bash -l
#SBATCH --job-name=genomad_CAMI_megahit
...
#SBATCH --array=1-10
#SBATCH --output=slurm_genomad_CAMI_megahit_%A_%a.out

## use genomad to identify plasmid contigs from megahit assemblies
...
# output files
OUT="${WORKDIR}/genomad_megahit_${SAMPLE_ID}_calibrated"
