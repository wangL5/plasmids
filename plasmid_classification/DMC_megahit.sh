#!/bin/bash -l
#SBATCH --job-name=DMC_CAMI_megahit
...
#SBATCH --array=1-10
#SBATCH --output=slurm_DMC_CAMI_megahit_%A_%a.out

## use DeepMicroClass (DMC) to identify plasmid contigs from megahit assemblies
...
# output files
OUT="${WORKDIR}/DMC_megahit_${SAMPLE_ID}"
