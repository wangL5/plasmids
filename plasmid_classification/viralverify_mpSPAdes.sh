#!/bin/bash -l
#SBATCH --job-name=viralverify_CAMI_mpSPAdes
...
#SBATCH --array=1-10
#SBATCH --output=slurm_viralverify_CAMI_mpSPAdes_%A_%a.out

## use viralverify to identify plasmid and virus contigs from metaplasmidspades assemblies
...
# output files
OUT="${WORKDIR}/viralverify_mpSPAdes_${SAMPLE_ID}/"
