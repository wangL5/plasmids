#!/bin/bash -l
#SBATCH --job-name=mobrecon_CAMI_mpSPAdes
...
#SBATCH --array=1-10
#SBATCH --output=slurm_mobrecon_CAMI_mpSPAdes_%A_%a.out

## use mob-recon as part of mobsuite to identify plasmid contigs from metaplasmidspades assemblies
...
# output files
OUT="${WORKDIR}/mobrecon_mpSPAdes_${SAMPLE_ID}/"
