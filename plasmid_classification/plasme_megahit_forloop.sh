#!/bin/bash -l
#SBATCH --job-name=PLASMe_CAMI_megahit_samples_for_loop
#SBATCH --time=168:00:00
#SBATCH --mem=250G
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --output=slurm_PLASMe_CAMI_megahit_forloop_%A.out

## use PLASMe to identify plasmid contigs from megahit
